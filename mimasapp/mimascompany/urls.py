...
from .views.manage_employeetask import create_task_category, delete_task_category, edit_task_category, list_task_categories, \
    ...
    create_item_employeedash, view_task_category, view_task, view_task_item
...
urlpatterns = [
    ...
    path('viewdentist/<int:den_id>/view/', view_dentist, name='viewdentist'),
    ...
    path('viewposition/<int:pos_id>/view/', view_position, name='viewposition'),
    ...
    path('edittaskcategory/<int:cat_id>/edit/', edit_task_category, name='edittaskcategory'),
    path('viewtaskcategory/<int:cat_id>/view/', view_task_category, name='viewtaskcategory'),
    path('deletetaskcategory/<int:cat_id>/delete/', delete_task_category, name='deletetaskcategory'),
    # Employee Tasks
    ...
    path('viewtask/<int:task_id>/view/', view_task, name='viewtask'),
    ...
    path('viewtaskitem/<int:item_id>/view/', view_task_item, name='viewtaskitem'),
    ...
    path('viewleaverequest/<int:req_id>/view/', view_leave_request, name='viewleaverequest'),
    ...
    path('viewemployeecontact/<int:con_id>/view/', view_employee_contact, name='viewemployeecontact'),
